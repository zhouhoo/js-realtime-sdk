...
var decode = function decode(value) {
  ...
  if (isPlainObject(value)) {
    return _Object$keys(value).reduce(function (result, key) {
      return _extends({}, result, _defineProperty({}, key, decode(value[key])));
    }, {});
  }
  return value;
};
...
var encode = function encode(value) {
  ...
  if (isPlainObject(value)) {
    return _Object$keys(value).reduce(function (result, key) {
      return _extends({}, result, _defineProperty({}, key, encode(value[key])));
    }, {});
  }
  return value;
};
...
var ConversationBase = function (_EventEmitter) {
  ...
  ConversationBase.prototype._addMembers = function _addMembers() {};
  ...
  ConversationBase.prototype._removeMembers = function _removeMembers() {};
...
var Conversation = function (_PersistentConversati) {
  ...
  Conversation.prototype._addMembers = function _addMembers(members) {
    var _this2 = this;
  ...
  Conversation.prototype._removeMembers = function _removeMembers(members) {
  ...
  Conversation.prototype._fetchAllMemberInfo = function () {
  ...
  Conversation.prototype.getAllMemberInfo = function () {
  ...
  Conversation.prototype.getMemberInfo = function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(memberId) {
  ...
  Conversation.prototype.updateMemberRole = function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(memberId, role) {
    ...
    function updateMemberRole(_x3, _x4) {
      return _ref5.apply(this, arguments);
    }
...
var transformNotFoundError = function transformNotFoundError(error$$1) {
  return error$$1.code === ErrorCode.CONVERSATION_NOT_FOUND ? createError({ code: ErrorCode.TEMPORARY_CONVERSATION_EXPIRED }) : error$$1;
};
...
var debug$8 = d('LC:SessionManager');
...
var SessionManager = function () {
  ...
  SessionManager.prototype.setSessionToken = function setSessionToken(token, ttl) {
    debug$8('set session token', token, ttl);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              ...
              debug$8('refresh expired session token');
              _context2.next = 14;
            ...
            case 14:
              ...
              debug$8('session token', newValue);
              return _context2.abrupt('return', newValue);

            case 18:
              debug$8('session token', value);
...
var IMClient = (_dec$2 = throttle(1000), _dec2 = throttle(1000), (_class$3 = function (_EventEmitter) {
  ...
  IMClient.prototype._open = function () {
    var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(appId, tag, deviceId) {
  ...
  IMClient.prototype._syncNotifications = function () {
    var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(timestamp) {
      var _this7 = this;
  ...
  IMClient.prototype._fetchNotifications = function () {
    var _ref14 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(timestamp) {
      return _regeneratorRuntime.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
    ...
    return new SessionManager({
      ...
      refresh: function refresh(manager, expiredSessionToken) {
        return manager.setSessionTokenAsync(_Promise.resolve(new GenericCommand({
          ...
          var _ref15 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(command) {
            var signatureResult;
            return _regeneratorRuntime.wrap(function _callee8$(_context8) {
              while (1) {
                switch (_context8.prev = _context8.next) {
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 2:
              ...
              return _context9.abrupt('return', this._request(_extends({
                headers: _extends({
  ...
  IMClient.prototype.ping = function () {
    var _ref20 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee11(clientIds) {
  ...
  IMClient.prototype.getConversation = function () {
    var _ref21 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee12(id) {
  ...
  IMClient.prototype.getConversations = function () {
    var _ref22 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee13(ids) {
      var _this9 = this;
  ...
  IMClient.prototype._getTemporaryConversations = function () {
    var _ref23 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee14(ids) {
      var command, resCommand;
      return _regeneratorRuntime.wrap(function _callee14$(_context14) {
        while (1) {
          switch (_context14.prev = _context14.next) {
  ...
  IMClient.prototype._executeQuery = function () {
    var _ref24 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee15(query) {
  ...
  IMClient.prototype._handleQueryResults = function () {
    var _ref25 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee16(resCommand) {
  ...
  IMClient.prototype.parseMessage = function () {
    var _ref27 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee17(_ref26) {
  ...
  IMClient.prototype.parseConversation = function () {
    var _ref29 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee18(_ref28) {
      var id = _ref28.id,
  ...
  IMClient.prototype._parseConversationFromRawData = function () {
    var _ref30 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee19(rawData) {
      var data, ttl;
  ...
  IMClient.prototype.createConversation = function () {
    var _ref32 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee20() {
  ...
  IMClient.prototype.createChatRoom = function () {
    var _ref34 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee21(param) {
      return _regeneratorRuntime.wrap(function _callee21$(_context21) {
        while (1) {
          switch (_context21.prev = _context21.next) {
            case 0:
              return _context21.abrupt('return', this.createConversation(_extends({}, param, {
                transient: true,
                members: null,
                unique: false
              })));
      ...
      return _regeneratorRuntime.wrap(function _callee22$(_context22) {
        while (1) {
          switch (_context22.prev = _context22.next) {
            case 0:
              return _context22.abrupt('return', this.createConversation(_extends({}, param, {
                transient: false,
                unique: false,
                _tempConv: true,
  ...
  return IMClient;
}(EventEmitter), (_applyDecoratedDescriptor$1(_class$3.prototype, '_doSendAck', [_dec$2], _Object$getOwnPropertyDescriptor(_class$3.prototype, '_doSendAck'), _class$3.prototype), _applyDecoratedDescriptor$1(_class$3.prototype, '_doSendRead', [_dec2], _Object$getOwnPropertyDescriptor(_class$3.prototype, '_doSendRead'), _class$3.prototype)), _class$3));
...
var debug$a = d('LC:MessageParser');
...
var MessageParser = (_class$6 = function () {
  ...
  MessageParser.prototype.parse = function parse(content) {
    debug$a('parsing message: %O', content);
    // eslint-disable-next-line no-restricted-syntax
...
var beforeCommandDispatch = function beforeCommandDispatch(command, realtime) {
  ...
  if (targetClient) {
    ...
    debug$b('[WARN] Unexpected message received without any live client match: %O', trim(command));
  }
  return false;
};
...
var Event$1 = _extends({}, CoreEvent, Event);
