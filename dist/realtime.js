...
var BlacklistCommand = _messages$push_server.BlacklistCommand;
var PatchCommand = _messages$push_server.PatchCommand;
var PatchItem = _messages$push_server.PatchItem;
var ConvMemberInfo = _messages$push_server.ConvMemberInfo;
...
var Expirable = function () {
  ...
  _createClass(Expirable, [{
    ...
    get: function get() {
      ...
      if (expired) debug$3('expired: ' + this.originalValue);
...
var Realtime = function (_EventEmitter) {
  ...
  Realtime.prototype._request = function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(_ref) {
      ...
      var _options, appId, region, _ref3, api, url, options;
...
var ConversationBase = function (_EventEmitter) {
  ...
  function ConversationBase(_ref, client) {
    ...
    ['kicked', 'membersjoined', 'membersleft', 'memberinfoupdated', 'blocked', 'unblocked', 'membersblocked', 'membersunblocked', 'muted', 'unmuted', 'membersmuted', 'membersunmuted', 'message', 'receipt', 'lastdeliveredatupdate', 'lastreadatupdate', 'messagerecall', 'messageupdate', 'infoupdated'].forEach(function (event) {
...
var createPartiallySuccess = function createPartiallySuccess(_ref) {
  ...
  return {
    ...
    failures: failedPids.map(function (_ref2) {
      ...
      return _Object$assign(createError(error$$1), { clientIds: pids });
    })
  };
};
...
var PersistentConversation = function (_ConversationBase) {
  ...
  PersistentConversation.prototype._appendConversationSignature = function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(command, action, clientIds) {
  ...
  PersistentConversation.prototype._appendBlacklistSignature = function () {
    var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(command, action, clientIds) {
      var params, signatureResult;
      return _regeneratorRuntime.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
  ...
  PersistentConversation.prototype.add = function () {
    var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(clientIds) {
  ...
  PersistentConversation.prototype.remove = function () {
    var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(clientIds) {
  ...
  PersistentConversation.prototype.muteMembers = function () {
    var _ref18 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee11(clientIds) {
  ...
  PersistentConversation.prototype.unmuteMembers = function () {
    var _ref20 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee12(clientIds) {
  ...
  PersistentConversation.prototype.blockMembers = function () {
    var _ref25 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee14(clientIds) {
  ...
  PersistentConversation.prototype.unblockMembers = function () {
    var _ref27 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee15(clientIds) {
  ...
  PersistentConversation.prototype.queryBlockedMembers = function () {
    var _ref29 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee16() {
  ...
  PersistentConversation.prototype.getAllMemberInfo = function () {
    var _ref32 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee17() {
      var _this5 = this;
  ...
  PersistentConversation.prototype.getMemberInfo = function () {
    var _ref33 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee18(memberId) {
  ...
  PersistentConversation.prototype.updateMemberRole = function () {
    var _ref34 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee19(memberId, role) {
...
var debug$10 = d('LC:SessionManager');
...
var SessionManager = function () {
  ...
  SessionManager.prototype.setSessionToken = function setSessionToken(token, ttl) {
    debug$10('set session token', token, ttl);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              ...
              debug$10('refresh expired session token');
              _context2.next = 14;
            ...
            case 14:
              ...
              debug$10('session token', newValue);
              return _context2.abrupt('return', newValue);

            case 18:
              debug$10('session token', value);
...
var IMClient = (_dec = throttle(1000), _dec2 = throttle(1000), (_class$1 = function (_EventEmitter) {
  ...
  function IMClient(id) {
    ...
    ['invited', 'kicked', 'membersjoined', 'membersleft', 'memberinfoupdated', 'blocked', 'unblocked', 'membersblocked', 'membersunblocked', 'muted', 'unmuted', 'membersmuted', 'membersunmuted', 'message', 'unreadmessagescountupdate', 'close', 'conflict', 'unhandledmessage', 'reconnect', 'reconnecterror', 'conversationinfoupdated'].forEach(function (event) {
      return _this.on(event, function () {
        for (var _len = arguments.length, payload = Array(_len), _key = 0; _key < _len; _key++) {
          payload[_key] = arguments[_key];
        }
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 27:
              ...
              this.emit('membersblocked', _payload4, conversation);
              /**
               * 有成员被加入当前对话的黑名单
               ...
               * @param {String} payload.blockedBy 该操作的发起者 id
               */
              conversation.emit('membersblocked', _payload4);
              return _context4.abrupt('return');
            ...
            case 31:
              ...
              this.emit('membersunblocked', _payload5, conversation);
              /**
               * 有成员被移出当前对话的黑名单
               ...
               * @param {String} payload.unblockedBy 该操作的发起者 id
               */
              conversation.emit('membersunblocked', _payload5);
              return _context4.abrupt('return');
            ...
            case 35:
              ...
              this.emit('blocked', _payload6, conversation);
              /**
               * 当前用户被加入当前对话的黑名单
               ...
               * @param {String} payload.blockedBy 该操作的发起者 id
               */
              conversation.emit('blocked', _payload6);
              return _context4.abrupt('return');
            ...
            case 39:
              ...
              this.emit('unblocked', _payload7, conversation);
              /**
               * 当前用户被移出当前对话的黑名单
               ...
               * @param {String} payload.unblockedBy 该操作的发起者 id
               */
              conversation.emit('unblocked', _payload7);
              return _context4.abrupt('return');
            ...
            case 43:
              ...
              this.emit('membersmuted', _payload8, conversation);
              /**
               * 有成员在当前对话中被禁言
               ...
               * @param {String} payload.mutedBy 该操作的发起者 id
               */
              conversation.emit('membersmuted', _payload8);
              return _context4.abrupt('return');
            ...
            case 47:
              ...
              this.emit('membersunmuted', _payload9, conversation);
              /**
               * 有成员在当前对话中被解除禁言
               ...
               * @param {String} payload.unmutedBy 该操作的发起者 id
               */
              conversation.emit('membersunmuted', _payload9);
              return _context4.abrupt('return');
            ...
            case 51:
              ...
              this.emit('muted', _payload10, conversation);
              /**
               * 有成员在当前对话中被禁言
               ...
               * @param {String} payload.mutedBy 该操作的发起者 id
               */
              conversation.emit('muted', _payload10);
              return _context4.abrupt('return');
            ...
            case 55:
              ...
              this.emit('unmuted', _payload11, conversation);
              /**
               * 有成员在当前对话中被解除禁言
               ...
               * @param {String} payload.unmutedBy 该操作的发起者 id
               */
              conversation.emit('unmuted', _payload11);
              return _context4.abrupt('return');
            ...
            case 65:
              ...
              this.emit('memberinfoupdated', _payload12, conversation);
              /**
               * 有成员的对话信息被更新
               ...
               * @param {String} payload.updatedBy 该操作的发起者 id
               */
              conversation.emit('memberinfoupdated', _payload12);
              return _context4.abrupt('return');

            case 71:
              attributes = decode$1(JSON.parse(attr.data));
              ...
              this.emit('conversationinfoupdated', _payload13, conversation);
              /**
               * 有对话信息被更新
               ...
               * @param {String} payload.updatedBy 该操作的发起者 id
               */
              conversation.emit('infoupdated', _payload13);
              return _context4.abrupt('return');
  ...
  IMClient.prototype._open = function _open(appId, tag, deviceId) {
    ...
    var _internal2 = internal(this),
        lastUnreadNotifTime = _internal2.lastUnreadNotifTime,
        lastPatchTime = _internal2.lastPatchTime;
    ...
    return _Promise.resolve(new GenericCommand({
      ...
      var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(command) {
        var sessionToken, signatureResult;
        return _regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 3;
                return _this7._sessionManager.getSessionToken({ autoRefresh: false });
              ...
              case 3:
                ...
                return _context5.abrupt('return', command);
              ...
              case 7:
                ...
                _context5.next = 11;
                return runSignatureFactory(_this7.options.signatureFactory, [_this7._identity]);
      ...
      if (token) {
        _this7._sessionManager = _this7._sessionManager || _this7._createSessionManager();
        _this7._sessionManager.setSessionToken(token, tokenTTL);
      }
    }).catch(function (error$$1) {
      if (error$$1.code === ErrorCode.SESSION_TOKEN_EXPIRED) {
        if (!_this7._sessionManager) {
    ...
    return new SessionManager({
      ...
      refresh: function refresh(manager, expiredSessionToken) {
        return manager.setSessionTokenAsync(_Promise.resolve(new GenericCommand({
          ...
          var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(command) {
            var signatureResult;
            return _regeneratorRuntime.wrap(function _callee6$(_context6) {
              while (1) {
                switch (_context6.prev = _context6.next) {
                  ...
                  case 5:
                    return _context6.abrupt('return', command);
        ...
        }()).then(_this8._send.bind(_this8)).then(function (_ref13) {
          var _ref13$sessionMessage = _ref13.sessionMessage,
              token = _ref13$sessionMessage.st,
              ttl = _ref13$sessionMessage.stTtl;
          return [token, ttl];
        }));
      }
    });
  ...
  IMClient.prototype._requestWithSessionToken = function () {
    var _ref15 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(_ref14) {
      var headers = _ref14.headers,
          query = _ref14.query,
          params = _objectWithoutProperties(_ref14, ['headers', 'query']);
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 2:
              ...
              return _context7.abrupt('return', this._request(_extends({
                headers: _extends({
    ...
    function _requestWithSessionToken(_x9) {
  ...
  IMClient.prototype.ping = function () {
    var _ref17 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9(clientIds) {
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 3:
              ...
              return _context9.abrupt('return', _Promise.resolve([]));
            ...
            case 8:
              ...
              return _context9.abrupt('return', resCommand.sessionMessage.onlineSessionPeerIds);
  ...
  IMClient.prototype.getConversation = function () {
    var _ref18 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee10(id) {
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            ...
            case 2:
              ...
              return _context10.abrupt('return', cachedConversation);
            ...
            case 13:
              return _context10.abrupt('return', this.getQuery().equalTo('objectId', id).find().then(function (conversations) {
  ...
  IMClient.prototype.getConversations = function () {
    var _ref19 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee11(ids) {
      var _this9 = this;
      ...
      return _regeneratorRuntime.wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            ...
            case 8:
              return _context11.abrupt('return', ids.map(function (id) {
  ...
  IMClient.prototype._getTemporaryConversations = function () {
    var _ref20 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee12(ids) {
      var command, resCommand;
      return _regeneratorRuntime.wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            ...
            case 3:
              resCommand = _context12.sent;
              return _context12.abrupt('return', this._handleQueryResults(resCommand));
  ...
  IMClient.prototype._executeQuery = function () {
    var _ref21 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee13(query) {
      ...
      return _regeneratorRuntime.wrap(function _callee13$(_context13) {
        while (1) {
          switch (_context13.prev = _context13.next) {
            ...
            case 5:
              resCommand = _context13.sent;
              return _context13.abrupt('return', this._handleQueryResults(resCommand));
  ...
  IMClient.prototype._handleQueryResults = function () {
    var _ref22 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee14(resCommand) {
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            case 0:
              ...
              conversations = decode$1(JSON.parse(resCommand.convMessage.results.data));
              _context14.next = 9;
              break;
            ...
            case 5:
              ...
              throw new Error('Parse query result failed: ' + _context14.t0.message + '. Command: ' + commandString);
            ...
            case 11:
              conversations = _context14.sent;
              return _context14.abrupt('return', conversations.map(this._upsertConversationToCache.bind(this)));
  ...
  IMClient.prototype.parseMessage = function () {
    var _ref24 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee15(_ref23) {
      var data = _ref23.data,
          _ref23$bin = _ref23.bin,
          bin = _ref23$bin === undefined ? false : _ref23$bin,
          properties = _objectWithoutProperties(_ref23, ['data', 'bin']);
  ...
  IMClient.prototype.parseConversation = function () {
    var _ref26 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee16(_ref25) {
      var id = _ref25.id,
          lastMessageAt = _ref25.lastMessageAt,
          lastMessage = _ref25.lastMessage,
          lastDeliveredAt = _ref25.lastDeliveredAt,
          lastReadAt = _ref25.lastReadAt,
          unreadMessagesCount = _ref25.unreadMessagesCount,
          members = _ref25.members,
          mentioned = _ref25.mentioned,
          properties = _objectWithoutProperties(_ref25, ['id', 'lastMessageAt', 'lastMessage', 'lastDeliveredAt', 'lastReadAt', 'unreadMessagesCount', 'members', 'mentioned']);
      ...
      return _regeneratorRuntime.wrap(function _callee16$(_context16) {
        while (1) {
          switch (_context16.prev = _context16.next) {
            ...
            case 4:
              conversationData.lastMessage = _context16.sent;
            ...
            case 6:
              ...
              return _context16.abrupt('return', new ChatRoom(conversationData, properties, this));
            ...
            case 9:
              ...
              return _context16.abrupt('return', new ServiceConversation(conversationData, properties, this));
            ...
            case 11:
              ...
              return _context16.abrupt('return', new TemporaryConversation(conversationData, { expiredAt: expiredAt }, this));

            case 13:
              return _context16.abrupt('return', new Conversation(conversationData, properties, this));
  ...
  IMClient.prototype._parseConversationFromRawData = function () {
    var _ref27 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee17(rawData) {
      var data, ttl;
      return _regeneratorRuntime.wrap(function _callee17$(_context17) {
        while (1) {
          switch (_context17.prev = _context17.next) {
            case 0:
              ...
              return _context17.abrupt('return', this.parseConversation(data));
  ...
  IMClient.prototype.createConversation = function () {
    var _ref29 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee18() {
      var _ref28 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

      var m = _ref28.members,
          name$$1 = _ref28.name,
          transient = _ref28.transient,
          unique = _ref28.unique,
          tempConv = _ref28._tempConv,
          tempConvTTL = _ref28._tempConvTTL,
          properties = _objectWithoutProperties(_ref28, ['members', 'name', 'transient', 'unique', '_tempConv', '_tempConvTTL']);

      var members, attr, startCommandJson, command, _params, signatureResult, _ref30, _ref30$convMessage, cid, cdate, ttl, data, conversation;
      ...
      return _regeneratorRuntime.wrap(function _callee18$(_context18) {
        while (1) {
          switch (_context18.prev = _context18.next) {
            ...
            case 17:
              signatureResult = _context18.sent;
            ...
            case 21:
              ...
              _ref30$convMessage = _ref30.convMessage;
              cid = _ref30$convMessage.cid;
              cdate = _ref30$convMessage.cdate;
              ttl = _ref30$convMessage.tempConvTTL;
              data = _extends({
                name: name$$1,
                transient: transient,
                unique: unique,
            ...
            case 30:
              conversation = _context18.sent;
              return _context18.abrupt('return', this._upsertConversationToCache(conversation));
  ...
  IMClient.prototype.createChatRoom = function () {
    var _ref31 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee19(param) {
      return _regeneratorRuntime.wrap(function _callee19$(_context19) {
        while (1) {
          switch (_context19.prev = _context19.next) {
            case 0:
              return _context19.abrupt('return', this.createConversation(_extends({}, param, {
                transient: true,
                members: null,
                unique: false
              })));
  ...
  IMClient.prototype.createTemporaryConversation = function () {
    var _ref33 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee20(_ref32) {
      var _tempConvTTL = _ref32.ttl,
          param = _objectWithoutProperties(_ref32, ['ttl']);

      return _regeneratorRuntime.wrap(function _callee20$(_context20) {
        while (1) {
          switch (_context20.prev = _context20.next) {
            case 0:
              return _context20.abrupt('return', this.createConversation(_extends({}, param, {
                transient: false,
                unique: false,
                _tempConv: true,
    ...
    function createTemporaryConversation(_x23) {
      return _ref33.apply(this, arguments);
    }
...
var debug$11 = d('LC:MessageParser');
...
var onRealtimeCreate = function onRealtimeCreate(realtime) {
  ...
  var createIMClient = function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(identity) {
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 18:
              ...
              promise = realtime._open().then(function (connection) {
                var client = new IMClient(id, _extends({}, buildinOptions, clientOptions), {
